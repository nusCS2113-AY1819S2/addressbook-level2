...
public class UniquePersonList implements Iterable<Person> {
     ...
     */
    public void sort() {
        Collections.sort(internalList, UniquePersonList.PersonNameComparator);
    }
    ...
    public static Comparator<Person> PersonNameComparator = new Comparator<Person>() {
        ...
        public int compare(Person s1, Person s2) {
            String PersonName1 = s1.getName().toString().toUpperCase();
            String PersonName2 = s2.toString().toUpperCase();
