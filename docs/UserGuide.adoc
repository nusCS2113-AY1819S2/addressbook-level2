...
== Happy Chinese New Year: "HappyCNY"

This application will represent the coders to say Happy Chinese New Year to the users
and ask then have they done their homework.
...
* 'HappyCNY'
Returns "Happy Chinese New Year!!! Have you done your homework???"
