...
== Finding all persons with the specified phone number : `findp`

Find persons whose phone number is the same as the user input.
Format: `findp PHONE NUMBER`

Examples:

* `findp 12345678` +
Returns all the people with the phone number 12345678.
