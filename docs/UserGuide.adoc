...
* List contacts ('list': shows non-private details), ('listall': shows all details)
...
== Listing all persons, including private details : `listall`

Shows a list of all persons with all details, in the address book. +
Format: `list`
