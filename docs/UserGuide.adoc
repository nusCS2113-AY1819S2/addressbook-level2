...
* Supports login function (`Enter your Username` and `Enter your Password`: will be shown at the start of the program)

== Logging in

The program will repeatedly request for login details.
Usernames and passwords are case sensitive.
You are not allowed to proceed without a valid username and password.
